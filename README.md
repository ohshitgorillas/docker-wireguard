...
| `-e IP6_SUBNET=` | IPv6 subnet for dual-stack tunnel configuration (e.g. `2001:db8:420:b00b::`). Use CIDR prefix /64–/112. Server gets `::1/128`, peers get sequential `::2/128`, `::3/128`, etc. Requires a static IPv6 route on your router. See [IPv6 Support](#ipv6-support). |
